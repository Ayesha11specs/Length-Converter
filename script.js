...
function convertToOther(convertFrom, value) {
    switch (convertFrom) {
        ...
        case "yard": yardsToOther(parseFloat(value)); break; // changed to 'yardsToOther'
        case "km": kmToOther(parseFloat(value)); break;
        case "mile": milesToOther(parseFloat(value)); break; // changed to 'milesToOther'
    }
 }